...
const {getWarehouses,addWarehouse, deleteWarehouse, updateWarehouse, getWarehouseById}=require("../controllers/warehouseController")
...
router.get("/:id",protect,authorize("super_admin","admin","user"),getWarehouseById)
