...
const {register,login,getUserById,getMe,updateUser,listUsers,forgotPassword,resetPassword,checkSuperAdminExists,logout} = require("../controllers/userController");
