...
exports.addPurchase = async (req, res) => {
  try {
    const purchase = new Purchase({...req.body,created_by:req.user._id,created_by_role:req.user.role});
    await purchase.save();
    res.json(purchase);
  } catch (err) {
...
exports.updatePurchase=async (req,res) => {
  try{
    ...
    const updated=await Purchase.findByIdAndUpdate(req.params.id,allowedFields,{new:true})
